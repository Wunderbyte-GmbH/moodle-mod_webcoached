...
$string['messagebody'] = 'Benachrichtigungstext';
$string['messagebody_help'] = 'Die Nachricht, die an die Lernenden gesendet wird, wenn das externe Webcoached-System den send_message-REST-Aufruf auslöst. Verfügbare Platzhalter: {name} – der Name der Aktivität, {link} – ein Link zur Aktivität, {course} – der Kursname, {courselink} – ein Link zum Kurs. Bleibt das Feld leer, wird ein Standardtext verwendet.';
$string['messagebodydefault'] = 'Sie haben eine neue Nachricht im Modul "{courselink}". Klicken Sie auf den Link "{link}", um die Nachricht auf der Bearbeitungsplattform einzusehen.';
$string['messageprovider:webcoachedmessage'] = 'Webcoached-Aktivitätsbenachrichtigungen';
$string['messagesubject'] = 'Neue Nachricht für "{$a}"';
...
$string['webcoached:sendmessage'] = 'Den send_message-Benachrichtigungs-Callback auslösen';
