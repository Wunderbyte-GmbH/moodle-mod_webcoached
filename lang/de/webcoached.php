...
$string['messagebody_help'] = 'Die Nachricht, die an die Lernenden gesendet wird, wenn das externe Webcoached-System den send_message-REST-Aufruf auslöst. Sie können den Platzhalter {name} für den Namen der Aktivität und {link} für einen Link zur Aktivität verwenden. Bleibt das Feld leer, wird ein Standardtext verwendet.';
$string['messagebodydefault'] = 'Sie haben eine neue Nachricht für die Aktivität "{name}" erhalten. Klicken Sie auf den Link {link}, um auf der Plattform "Webcoached" die Nachricht einzusehen.';
