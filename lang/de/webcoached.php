...
$string['messagebodydefault'] = 'Sie haben eine neue Nachricht im {courselink}. Klicken Sie auf den Link "{link}", um die Nachricht auf der Bearbeitungsplattform einzusehen.';
